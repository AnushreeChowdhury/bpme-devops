...
tibcoforms.formCode['_5nJwcPn3Eeuuh9nQQEuk5Q'] = new Object();
tibcoforms.formCode['_5nJwcPn3Eeuuh9nQQEuk5Q']['defineActions'] = function() {
var fc = tibcoforms.formCode['_5nJwcPn3Eeuuh9nQQEuk5Q'];
...
tibcoforms.formCode['_5nJwcPn3Eeuuh9nQQEuk5Q']['defineActions']();

tibcoforms.formCode['_5nJwcPn3Eeuuh9nQQEuk5Q']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_5nJwcPn3Eeuuh9nQQEuk5Q'];
...
fc['validation_ErrorDetail_ErrorDetail__length'] = function(formId, controlName, cloneUID, listIndex) {
    var valScr = 'typeof context.stringValue != \'undefined\' && typeof bpm.forms.Util != \'undefined\' ? bpm.forms.Util.checkTextLength(context.stringValue, 250) ? true : [context.control.label ? context.control.label : context.control.name, \'250\'] : context.value.length <= 250;';
...
fc['validation_CaseOutOfSynchError_CaseOutOfSynchError__length'] = function(formId, controlName, cloneUID, listIndex) {
    var valScr = 'typeof context.stringValue != \'undefined\' && typeof bpm.forms.Util != \'undefined\' ? bpm.forms.Util.checkTextLength(context.stringValue, 150) ? true : [context.control.label ? context.control.label : context.control.name, \'150\'] : context.value.length <= 150;';
...
tibcoforms.formCode['_5nJwcPn3Eeuuh9nQQEuk5Q']['defineValidations']();
