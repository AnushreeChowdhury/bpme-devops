...
tibcoforms.formCode['_51S6IPn3Eeuuh9nQQEuk5Q'] = new Object();
tibcoforms.formCode['_51S6IPn3Eeuuh9nQQEuk5Q']['defineActions'] = function() {
var fc = tibcoforms.formCode['_51S6IPn3Eeuuh9nQQEuk5Q'];
...
tibcoforms.formCode['_51S6IPn3Eeuuh9nQQEuk5Q']['defineActions']();

tibcoforms.formCode['_51S6IPn3Eeuuh9nQQEuk5Q']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_51S6IPn3Eeuuh9nQQEuk5Q'];
...
fc['validation_Claims_timeofincident_Claims_timeofincident__datetime'] = function(formId, controlName, cloneUID, listIndex) {
    ...
    return bpm.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Claims_timeofincident__datetime", true, true);
}
    
    
    
    
fc['validation_Claims_claimamount_Claims_claimamount__float'] = function(formId, controlName, cloneUID, listIndex) {
    ...
    return bpm.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Claims_claimamount__float", true, true);
}
    
fc['validation_Claims_claimId_Claims_claimId__length'] = function(formId, controlName, cloneUID, listIndex) {
    ...
    return bpm.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Claims_claimId__length", true, true);
}
    
    
fc['validation_Claims_descriptionOfLoss_Claims_descriptionOfLoss__length'] = function(formId, controlName, cloneUID, listIndex) {
    var valScr = 'typeof context.stringValue != \'undefined\' && typeof bpm.forms.Util != \'undefined\' ? bpm.forms.Util.checkTextLength(context.stringValue, 50) ? true : [context.control.label ? context.control.label : context.control.name, \'50\'] : context.value.length <= 50;';
    return bpm.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Claims_descriptionOfLoss__length", true, true);
}
    ...
    fc['DataModel'] = function(formId) {
        ...
        Object.defineProperty(this, 'Claims', {
            get: function() {
                return this.form.dataMap['Claims'].value;
            },
            set: function(value) {
...
tibcoforms.formCode['_51S6IPn3Eeuuh9nQQEuk5Q']['defineValidations']();
