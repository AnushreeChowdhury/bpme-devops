/*
 * This provides an implementation of the BOM class com.example.fnolprocess.FNOLProcess.AddCounterparty. 
 */
bpm.data.Loader.classDefiner["com.example.fnolprocess.FNOLProcess.AddCounterparty"] = function() {
    /** Constructor. */
    ...
    theClass.LOADER.registerClass(theClass, "com.example.fnolprocess.FNOLProcess.AddCounterparty");
...
bpm.data.Loader.classDefiner["com.example.fnolprocess.FNOLProcess.AddCounterparty"]();

bpm.scriptUtil._internal.checkVersionCompatibility("AddCounterparty.js", "11.0.0.044");
