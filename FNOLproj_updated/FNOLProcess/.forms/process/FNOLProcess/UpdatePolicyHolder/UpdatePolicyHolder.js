/*
 * This provides an implementation of the BOM class com.example.fnolprocess.FNOLProcess.UpdatePolicyHolder. 
 */
bpm.data.Loader.classDefiner["com.example.fnolprocess.FNOLProcess.UpdatePolicyHolder"] = function() {
    /** Constructor. */
    ...
    theClass.LOADER.registerClass(theClass, "com.example.fnolprocess.FNOLProcess.UpdatePolicyHolder");
...
bpm.data.Loader.classDefiner["com.example.fnolprocess.FNOLProcess.UpdatePolicyHolder"]();

bpm.scriptUtil._internal.checkVersionCompatibility("UpdatePolicyHolder.js", "11.0.0.044");
